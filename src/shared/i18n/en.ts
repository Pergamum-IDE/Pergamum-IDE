...
export const enTranslations = {
  ...
  "fontCache.status.notScanned": "Local font information has not been scanned yet.",
  "fontCache.status.loaded": "Local fonts: {count} families (last scanned: {date})",
  "fontCache.status.error": "Failed to scan local fonts.",
  "fontCache.status.unsupported": "Local font access is not supported in this environment.",
  "fontCache.button.scan": "Scan local fonts",
  ...
  "fontPicker.button.moveUp": "Up",
  "fontPicker.button.moveDown": "Down",
  "fontPicker.button.remove": "Remove",
  "fontPicker.button.add": "Add",
