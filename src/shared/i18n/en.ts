...
export const enTranslations = {
  ...
  "textImport.dialog.description": "Import text files as Markdown documents with a selected character encoding.",
  "textImport.dialog.destinationHeading": "Destination folder",
  "textImport.dialog.destinationPlaceholder": "Destination folder selection will be added in the next step.",
  "textImport.dialog.dropPlaceholder": "Adding text files or folders will be implemented in the next step.",
