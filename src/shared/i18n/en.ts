...
export const enTranslations = {
  ...
  "settings.workbench.enablePlainTextDocuments.label": "Enable plain text files (.txt)",
  "settings.workbench.enablePlainTextDocuments.description": "When enabled, .txt files in the project can be treated as Pergamum documents. Markdown-only features such as Markdown preview and image link diagnostics are not available for .txt files.",
